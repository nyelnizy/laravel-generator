...
class GenerateCrud extends Command
{
     ...
     * @var string
     */
    protected $signature = 'crud:generate {model_name?} {file_name?} {--prefix} {--all=}';
            ...
            if (is_null($this->option('all'))) {
                ...
                foreach ($models as $index => $model_name) {
                    ...
                    if (file_exists($file_path)) {
                        ...
                        $this->generateCrud($model_name,$file_path,$pfx);
    ...
    private function generateCrud(string $model_name, string $file_path, $pfx)
    {
